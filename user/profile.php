                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                  ...
                  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="../income/add-income.html">Income</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="../customers/customers.html">Customer</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="../invoice/send-invoice.html">Invoice</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="../expenses/expenses.html">Expense</a>
                      </li>
                      <li class="nav-item">
